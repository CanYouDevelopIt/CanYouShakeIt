...
//
//
//	Mat pic = cv::imread("Images/no.png");
...
//			Mat srcBGR = Mat(pic.size(), CV_8UC3);
//			cvtColor(pic, srcBGR, CV_GRAY2BGR);
//			// Get the destination ROI (and make sure it is within the image)
//			int cx = (frame1.cols - 70) / 2;
//			Rect dstRC = Rect(cx, frame1.rows / 2, 70, 70);
//			Mat dstROI = frame1(dstRC);
